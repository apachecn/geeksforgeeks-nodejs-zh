...
> 原文:[https://www . geesforgeks . org/node-js-http2 stream-desced-method/](https://www.geeksforgeeks.org/node-js-http2stream-destroyed-method/)

**http2 stream . destroled**是 Http 2 模块内 http2stream 类的内置应用编程接口，用于在流被破坏时返回 true，反之则返回 false。
...
**参考:**T2【https://nodejs . org/dist/latest-v 12 . x/docs/API/http2 . html # http2 _ http2 stream _ destroy