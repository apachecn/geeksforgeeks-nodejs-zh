...
> 原文:[https://www . geesforgeks . org/node-js-http2 session-socket-method/](https://www.geeksforgeeks.org/node-js-http2session-socket-method/)
...
**参考:**T2【https://nodejs . org/dist/latest-v 12 . x/docs/API/https 2 . html # https 2 _ https 2 session _ socket