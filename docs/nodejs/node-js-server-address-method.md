...
> 原文:[https://www . geesforgeks . org/node-js-server-address-method/](https://www.geeksforgeeks.org/node-js-server-address-method/)
...
**参考:**[https://nodejs . org/dist/latest-v 12 . x/docs/API/TLS . html # TLS _ server _ address](https://nodejs.org/dist/latest-v12.x/docs/api/tls.html#tls_server_address)